...
bool hexDigitAdd(char n1,char n2,char &d,bool c);
bool binDigitAdd(char n1,char n2,char &d,bool c);
bool octDigitAdd(char n1,char n2,char &d,bool c);

int main(int argc, char** argv) {
    //Create the test numbers using character arrays
    char number1[]="12345698765432109876543210";//98765432109876543210";
    char number2[]="11111234567890123456789123";//123456123456";
